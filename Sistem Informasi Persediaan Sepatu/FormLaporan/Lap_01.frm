...
Private Sub cmdPrinter_Click()
                       ...
                       With Crpt2
                        ...
                        .ReportFileName = "D:\program_pipit\Laporan\lap_01.rpt"
                        .SelectionFormula = "day({barang_masuk.tgl_masuk})= " & Day(Me.tgl.Value) & " and month({barang_masuk.tgl_masuk})= " & Month(Me.tgl.Value) & " and year({barang_masuk.tgl_masuk})= " & Year(Me.tgl.Value) & " AND {jenis_sepatu.kd_jen}='" & Me.kd_jen.Text & "'"
                        .RetrieveDataFiles
