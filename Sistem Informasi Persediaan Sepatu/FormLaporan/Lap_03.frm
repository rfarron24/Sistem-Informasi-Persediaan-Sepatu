...
Private Sub cmdPrinter_Click()
                       ...
                       With Crpt2
                        ...
                        .ReportFileName = "D:\program_pipit\Laporan\lap_03.rpt"
                        .SelectionFormula = "day({pengeluaran_sepatu.Tgl_Keluar})= " & Day(Me.tgl.Value) & " and month({pengeluaran_sepatu.Tgl_Keluar})= " & Month(Me.tgl.Value) & " and year({pengeluaran_sepatu.Tgl_Keluar})= " & Year(Me.tgl.Value) & " AND {jenis_sepatu.kd_jen}='" & Me.kd_jen.Text & "'"
                        .RetrieveDataFiles
